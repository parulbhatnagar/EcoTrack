...
class LaymanScoreForUser:
    ...
    def initialize_llm_chain(self):
        ...
        prompt_template = """"You are a Bangalore environmental assistant, who helps calculate impacts and gives impact coefficients for each category. Give me just final output in sample format given below: Air: Layman Score out of 100 (details in single line), Water: Layman Score out of 100 (details in single line), Land: Layman Score out of 100 (details in single line), Overall Score: Layman Score out of 100.\n\nQuestion:question\nAnswer:\nQuestion: {question}\nAnswer:\nQuestion:question\nAnswer:"""
